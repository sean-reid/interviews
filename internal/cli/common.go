...
var synopses = map[string]string{
	...
	"describe": `interviews describe <problem-id> [--seed id] [--set k=v] [--json]`,
	"validate": `interviews validate [--content dir] [--json]`,
	...
	"session":  `interviews session start|stop|evidence|timeline|kubeconfig|proxy <problem-id> [--seed id]`,
	"redteam":  `interviews redteam <problem-id> [--driver claude|api] [--pack name] [--budget 30m] | interviews redteam ledger`,
	...
	"sessions show":      `interviews sessions show [<seed> | --seed id]`,
	"sessions log":       `interviews sessions log [<seed> | --seed id] [--follow]`,
